...
from contact.serializers import FAQCategorySerializer, SendUsQuerySerializer, PhoneNumberSerializer, EmailSerializer, AddressSerializer, FAQsSerializer, SocialMediaLinkSerializer, PhoneEmailAddressSerializer
from contact.models import FAQCategory, SendUsQuery, PhoneNumber, Email, Address, FAQs, SocialMediaLink
